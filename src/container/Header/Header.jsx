        ...
        <div className="lg:flex justify-center items-center relative">
            ...
            <motion.div
                ...
                <div className="h-[40rem] flex flex-col justify-center items-center ">
                    ...
                    <p className="mx-auto max-w-4xl font-display text-2xl text-gray-200  text-center">
                    ...
                    <div className="w-full lg:w-auto grid grid-cols-1 lg:grid-cols-4 gap-4 mt-24">
                        ...
                        <div className="rounded-lg border-2 border-gray-500/10 border-dotted px-4 py-2 text-center">
                            ...
                            <p className="text-gray-500 dark:text-gray-300 font-semibold text-xl">1year+</p>
                        </div>
                        <div className="rounded-lg border-2 border-gray-500/10 border-dotted px-4 py-2 text-center">
                        ...
                        <div className="rounded-lg border-2 border-gray-500/10 border-dotted px-4 py-2 text-center">
                            ...
                            <p className="text-gray-500 dark:text-gray-300 font-semibold text-xl">CV <FaDownload className='inline-block text-sm'></FaDownload></p>
                        </div>
                    </div>
                </div>
                {/* <motion.img
                ...
                <motion.div
                    ...
                    animate={screenX}
                    transition={{ duration: 1, ease: 'easeInOut' }}
                    className={`overlay absolute top-0 right-0 left-0 w-full ${isTheme === 'dark' ? '' : 'hidden'}  bottom-0 -z-10`}
                >
                      {/* <SphereModel/> */}
                </motion.div>
            ...
            <motion.div
                ...
                className='absolute circles -right-12 h-full'>

                {/* {[images.redux, images.sass].map((circle, index)=> <div className='circle-cmp w-24 rounded-full  shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px]' key={index}>
